...
QT_MOC_LITERAL(1, 18, 18), // "calibration_status"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 6) // "status"

    },
    "CalibrationWindow\0calibration_status\0"
    "\0status"
};
...
void CalibrationWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->calibration_status((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CalibrationWindow::calibration_status)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CalibrationWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<VideoWindow::staticMetaObject>(),
...
void *CalibrationWindow::qt_metacast(const char *_clname)
{
    ...
    return VideoWindow::qt_metacast(_clname);
}

int CalibrationWindow::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = VideoWindow::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
...
// SIGNAL 0
void CalibrationWindow::calibration_status(bool _t1)
{
